...
class _RankingScreenState extends State<RankingScreen>
  ...
  Widget _buildList() {
    if (_players.isEmpty && _isLoading) {
      ...
      itemBuilder: (context, index) {
        ...
        return Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
                color: rankColor?.withValues(alpha: 0.5) ?? Colors.white10,
          ...
          child: ListTile(
            ...
            subtitle: Text(
              'Vitorias: ${player.vitorias} | Kills: ${player.kills}',
            ...
            trailing: Column(
              ...
              children: [
                ...
                Text('PTS',
                    style:
                        GoogleFonts.exo2(fontSize: 10, color: Colors.white38)),
              ],
            ),
          ),
        );
